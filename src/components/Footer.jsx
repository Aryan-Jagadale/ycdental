...
const FooterComp = () => {
  return (
    <footer class="bg-[#00205B] text-center text-white dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="text-center">
            <h6 class="mb-4 flex justify-center font-semibold">
              Quick Links
            </h6>
            {
              footerLink.map((item)=>(
                <p class="mb-4">
                <Link to={item.urll} class="text-white dark:text-neutral-200">
                  {item.name}
                </Link>
              </p>
          ...
          <div class="text-center">
            ...
            <p class="mb-4 tracking-wide">166/1, Vedgaon Gupta</p>
