  ...
  return (
    <div className="">
      ...
      <section className="absolute border-white border-2 rounded-full md:bottom-[3%]  md:left-8 drop-shadow-lg flex items-center justify-between bg-gray-100  w-[100%] md:w-[30%]">
        <div
          className={`p-2 md:px-10 rounded-l-full md:p-6 flex items-center justify-center  cursor-pointer w-[50%] ${
            first && "bg-[#FFD900]"
          } `}
          onClick={handleColor}
        >
        ...
        <div
          className={`p-2 md:px-10 rounded-r-full md:p-6 flex items-center justify-center hover:bg-[#FFD900] cursor-pointer w-[50%] ${
            !first && "bg-[#FFD900]"
          } `}
          onClick={handleColor}
        >
