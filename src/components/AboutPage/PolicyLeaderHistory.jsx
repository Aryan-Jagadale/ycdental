...
const PolicyLeaderHistory = ({name,link}) => {
  ...
  return (
    <div className={`m-4 flex flex-col w-screen justify-center content-center items-center text-center py-10 px-5 shadow-xl ${name==="Policy / Governance"? "bgImgOne":"bgImageThree"} ${name==="History"? "bgImgTwo":""} ${name==="Leadership"? "bgImgThree":""} `}>
