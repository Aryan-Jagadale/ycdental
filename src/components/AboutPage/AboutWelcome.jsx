...
const AboutWelcome = () => {
  return (
    <div>
      ...
      >
        <h2 className="text-3xl divide-y-4 font-bold">
          {" "}
      ...
      <div className="flex auto-cols-2 mx-24">
        <div>
          <img
            src={aboutPageDent1}
            alt=""
            className="object-fill h-42 w-96 mt-2"
          />
          <img
            src={aboutPageDent2}
            alt=""
            className="object-fill h-38 w-48 mx-24"
          />
        </div>
        <div className="text-justify font-fam">
          <p className="flex-1 mx-32 mt-2 text-lg mb-15">
          ...
          <p className="flex-1 mx-32 mt-3 text-lg mb-15">
            ...
            Pathardi, Newasa, Jamkhed, Karjat, Shrigonda, Parner, Nagar Tahsil,
            etc.)
            <br />
            are deprived socio – economically and are chronically draught
            affected.{" "}
          </p>
          <p className="flex-1 mx-32 mt-3 text-lg mb-15">
            Also the needy population is deprived of Medical, Dental, Pharmacy &
            Paramedical education along with medical facilities.
          </p>
        </div>
      </div>
      <div>
        <p className="flex justify-center mx-24 text-lg mb-10 text-justify font-fam ">
          ...
          <br />
          With the setup available with us we are sure to meet the requirements
          laid down by the Dental Council of India and MUHS to start degree
          course (B.D.S.), simultaneously the foundation has plans for full
          fledged Dental Research Institute.
        </p>
      </div>
    </div>
  );
